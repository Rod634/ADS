...
//  ----- Dados do Aluno -----
//  Nome: Rodrigo Conceição da Silva
//  email: rodrigocsilva63@gmail.com
//  Matrícula: 2018216034
//  Semestre: 2
...
int q1(char *data){
  ...
  int mes, dia, ano, cont, quant = 0, aux = 0, i=0;
  ...
  if(data[cont] >= 0 && data[cont + 1] != '/'){
    ...
    cont = cont + 2;
  }else if (data[cont] >= 0 && data[cont + 1] == '/'){
    mes = data[cont] - '0';
    cont = cont + 1;
  }
...
int q4(char *strTexto, char *strBusca, int posicoes[30]){
    ...
    char frase[250], palavra[60];
    int frase1[250], frase2[250], palavra1[50], palavra2[50];
    int tfrase = 0, tpalavra = 0, x = 0, qtdOcorrencias = 0, i, j, l = 0, aux;
    strcpy(frase, strTexto);
...
int q5(int num){
    ...
    int invert = 0  , base= 0, aux = 0, quant = 0;
...
int q6(int numerobase, int numerobusca){
    int qtdOcorrencias = 0;
    char num[20], busca[20];
    int tam1, tam2, i, j, x, aux_i = 0;
    sprintf(num, "%i", numerobase);
